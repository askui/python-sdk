...
class ModelName:
    ...
    """Deprecated: not served by the AskUI API. Use `ASKUI__GEMINI__3_5__FLASH`."""
    ASKUI__GEMINI__2_5__PRO = "askui/gemini-2.5-pro"
    """Deprecated: not served by the AskUI API. Use `ASKUI__GEMINI__3_5__FLASH`."""
    ASKUI__GEMINI__3_5__FLASH = "askui/gemini-3.5-flash"
    ...
    """Deprecated: not served by the AskUI API anymore. Use `GEMINI__3_5__FLASH`."""
    GEMINI__2_5__PRO = "gemini-2.5-pro"
    """Deprecated: not served by the AskUI API anymore. Use `GEMINI__3_5__FLASH`."""
    GEMINI__3_5__FLASH = "gemini-3.5-flash"
